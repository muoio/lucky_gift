  ...
  function (e, t, r) {
    ...
    var o,
      ...
      B = u.default({}, p, {
        ...
        isInNimoStreamer: h,
        isInNimoPc: v,
        isIE: "Internet Explorer" === p.browser.name,
        isMSEdge: "Microsoft Edge" === p.browser.name,
        ua: c,
        parser: o || (o = d.default.getParser(c)),
        isIOS: P,
        isAdr: y,
        isCrawler: F,
        appBrowser: {
          name:
            (function () {
              var e = /(nimotv)|(nimostreamer)|(NimoPC)/.exec(
                navigator.userAgent
              );
              return e ? e[0] : null;
            })() ||
          ...
          version:
            ((a =
              /(?:nimotv|nimostreamer)-(.*)$/.exec(navigator.userAgent) ||
              /NimoPC\/(\S*)/.exec(navigator.userAgent)),
            (a ? a[1] : null) || p.browser.version),
        },
      });
    e.exports = B;
  },
